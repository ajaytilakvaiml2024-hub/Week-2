  ...
  return (
    <div className="w-full">
      <label
        ...
        ${isDragging ? 'border-emerald-500 bg-emerald-50 dark:bg-emerald-900/50' : 'border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700' }
      ...
      >
        ...
        <input id="image-upload" type="file" className="hidden" accept="image/png, image/jpeg, image/jpg" onChange={handleFileChange} />
      </label>
    </div>
  );
};
